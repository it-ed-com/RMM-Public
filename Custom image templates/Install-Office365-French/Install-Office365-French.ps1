...
Invoke-WebRequest -Uri "Remplace_GITHUBLINK" -OutFile "C:\HelpOX\GoldenImage\Office365\setup.exe"
Invoke-WebRequest -Uri "Remplace_GITHUBLINK" -OutFile "C:\HelpOX\GoldenImage\Office365\Configuration.xml"
