...
Description  : This script installs Git using winget on a custom Azure image.
...
$logDir = "C:\ited\logs"
$tempDir = "C:\ited\temp"
$logFile = "$logDir\aib-git_install.log"
...
try {
    ...
    # Install Git for all users using winget
    Write-Output "Starting Git installation..."
    winget install --id Git.Git --scope machine --silent --accept-package-agreements --accept-source-agreements
